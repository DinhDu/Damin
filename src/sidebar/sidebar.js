...
function Sidebar() {
    return (
        <Pane className="w-auto h-full px-3 py-2 fixed z-19 bg-gray-100 border-box">
            <Pane display="flex" className="w-224 h-8 flex-col border-box inherit">
                <Pane display="flex" className='flex-row items-center h-7 mb-5 w-full border-box'>
                    <Pane display="flex" className="flex-row flex-grow items-center w-202 h-7">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="18" viewBox="0 0 22 18" fill="none">
                            <path d="M21 9H2" stroke="#11142D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M21 1H12" stroke="#808191" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path opacity="0.301406" d="M21 17H12" stroke="#808191" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M6 4L1 9L6 14" stroke="#11142D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                </Pane>
                <Pane display="flex" className='flex-grow flex-col border-box'>
                    <Pane display="flex" className='h-6 w-full px-2 mt-1 items-center flex-row border-box rounded-md'>
                        <Pane display="flex" className='items-center w-24 h-6 pr-3 text-1 border-box'>
                        ...
                        <Pane display="flex" className='font-medium w-160 h-6 text-gray-500 items-center flex-grow'>
                            <p>Quản lí cơ hội</p>
                        </Pane>
                    </Pane>
                    <Pane display="flex" className='h-6 w-full px-2 mt-1 items-center flex-row border-box rounded-md'>
